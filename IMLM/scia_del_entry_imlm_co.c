...
.COMMENTS    Removes entries related to file "prodName" from tables:
             meta_imlm_co, tile_imlm_co
.ENVIRONment None
.VERSION     1.0     20-Mar-2008   initial release by R. M. van Hees
------------------------------------------------------------*/
/*
