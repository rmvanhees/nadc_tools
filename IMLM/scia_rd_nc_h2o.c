...
.IDENTifer   SCIA_RD_NC_H2O
.AUTHOR      R.M. van Hees
.KEYWORDS    SCIA IMLM H2O
.LANGUAGE    ANSI C
.PURPOSE     read IMLM-H2O product in ADAGUC format
.COMMENTS    contains SCIA_RD_NC_H2O_META and SCIA_RD_NC_H2O_REC
.ENVIRONment None
...
/*+++++++++++++++++++++++++
.IDENTifer   SCIA_RD_NC_H2O_META
.PURPOSE     read header from IMLM-H2O product in netCDF-4 (ADAGUC standard)
.INPUT/OUTPUT
  call as   SCIA_RD_NC_H2O_META( ncid, &hdr );
     input:
...
-------------------------*/
void SCIA_RD_NC_H2O_META( int ncid, struct imlm_hdr *hdr )
{
     const char prognm[] = "SCIA_RD_NC_H2O_META";
...
{
     const char prognm[] = "SCIA_RD_NC_H2O_REC";
