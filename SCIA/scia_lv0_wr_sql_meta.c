...
.INPUT/OUTPUT
  call as   SCIA_LV0_WR_SQL_META( conn, be_verbose, sciafl, mph );
     input:  
...
void SCIA_LV0_WR_SQL_META( PGconn *conn, bool be_verbose, const char *sciafl, 
			   const struct mph_envi *mph )
{
     const char prognm[] = "SCIA_LV0_WR_SQL_META";
