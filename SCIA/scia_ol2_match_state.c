...
.INPUT/OUTPUT
  call as   SCIA_OL2_MATCH_STATE( conn, be_verbose, mph, numState, state );
     input:  
...
void SCIA_OL2_MATCH_STATE( PGconn *conn, bool be_verbose,
 ...
 */
     numChar = snprintf( sql_long_query, sql_long_sz, 
			 "INSERT INTO stateinfo_meta__2P VALUES(%-d,%-d,\'{",
