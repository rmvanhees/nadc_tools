...
.INPUT/OUTPUT
  call as   CRE_SCIA_LV0_H5_STRUCTS();
            CRE_SCIA_LV1_H5_STRUCTS();
            CRE_SCIA_LV2_H5_STRUCTS();
...
.PURPOSE     create data structures to store SCIAMACHY compound data types
.INPUT/OUTPUT
  call as   CRE_SCIA_LV1_H5_STRUCTS();

.RETURNS     Nothing
.COMMENT     None
-------------------------*/
void CRE_SCIA_LV1_H5_STRUCTS(void)
{
 ...
 */
     CRE_SCIA_H5_STRUCT_MJD(fid, &mjd_id);
     (void) H5Tclose(mjd_id);
     CRE_SCIA_H5_STRUCT_COORD(fid, &coord_id);
     (void) H5Tclose(coord_id);
     CRE_SCIA_H5_STRUCTS_LV01(fid);
/*
 * Packet header
 */
     ...
     (void) H5Tcommit(fid, "packet_hdr", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);
 ...
 */
     ...
     (void) H5Tcommit(fid, "data_hdr", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);
/*
 * PMTC header
 */
     ...
     (void) H5Tclose(arr_id);
     (void) H5Tcommit(fid, "pmtc_hdr", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);
/*
 * Clcon structure
 */
     ...
     (void) H5Tinsert(type_id, "pet", 
		       ...
		       H5T_NATIVE_FLOAT);
     (void) H5Tcommit(fid, "Clcon", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);    
     (void) H5Tclose(type_id);
/*
 ...
 */
     ...
     (void) H5Tcommit(fid, "Sig", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);    
     (void) H5Tclose(type_id);
/*
 ...
 */
     ...
     (void) H5Tinsert(type_id, "det", 
		       ...
		       H5T_NATIVE_UINT);
     (void) H5Tpack(type_id);
     (void) H5Tcommit(fid, "Sigc", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);    
     (void) H5Tclose(type_id);
}
...
.PURPOSE     create data structures to store SCIAMACHY compound data types
.INPUT/OUTPUT
  call as   CRE_SCIA_LV2_H5_STRUCTS();

.RETURNS     nothing
.COMMENTS    nothing
-------------------------*/
void CRE_SCIA_LV2_H5_STRUCTS(void)
{
     hid_t   type_id;
     hid_t   arr_id;
 ...
 */
     ...
     (void) H5Tclose(arr_id);
     (void) H5Tcommit(fid, "bias_win", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);
/*
 ...
 */
     ...
     (void) H5Tinsert(type_id, "wv_max",
		       ...
		       H5T_NATIVE_USHORT);
     (void) H5Tcommit(fid, "doas_win", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);
}
...
.PURPOSE     create data structures to store SCIAMACHY compound data types
.INPUT/OUTPUT
  call as   CRE_SCIA_OL2_H5_STRUCTS();

.RETURNS     nothing
.COMMENTS    nothing
-------------------------*/
void CRE_SCIA_OL2_H5_STRUCTS(void)
{
     hid_t   type_id;
     hid_t   arr_id;
     hid_t   mjd_id, coord_id;
 ...
 */
     ...
     (void) H5Tinsert(type_id, "errvertcol",
		       ...
		       H5T_NATIVE_FLOAT);
     (void) H5Tcommit(fid, "layer_rec", type_id,
		       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);     
/*
 ...
 */
     ...
     (void) H5Tinsert(type_id, "winmax",
		      ...
		      H5T_NATIVE_FLOAT);
     (void) H5Tcommit(fid, "meas_grid", type_id,
		      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);     
/*
 ...
 */
     ...
     (void) H5Tcommit(fid, "state_vec", type_id,
		      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
     (void) H5Tclose(type_id);     
     (void) H5Tclose(arr_id);
/*
