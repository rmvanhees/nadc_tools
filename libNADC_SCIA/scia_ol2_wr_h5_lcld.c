/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.COPYRIGHT (c) 2011 - 2019 SRON (R.M.van.Hees@sron.nl)
...
.INPUT/OUTPUT
  call as    SCIA_OL2_WR_H5_LCLD(lcld_name, nr_lcld, lcld);
     input:  
...
void SCIA_OL2_WR_H5_LCLD(unsigned int nr_lcld, const struct lcld_scia *lcld)
{
 ...
 */
     lcld_type[0] = H5Topen(fid, "mjd", H5P_DEFAULT);
