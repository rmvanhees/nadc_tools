...
.INPUT/OUTPUT
  call as    SCIA_LV1_WR_H5_RSPN(nr_rsp, rspn);
             SCIA_LV1_WR_H5_RSPL(nr_rsp, rsplo);
             SCIA_LV1_WR_H5_RSPO(nr_rsp, rsplo);
     input:  
...
void SCIA_LV1_WR_H5_RSPN(unsigned int nr_rsp, const struct rspn_scia *rspn)
{
     hid_t   gads_id;
     hsize_t adim;
     herr_t  stat;
...
void SCIA_LV1_WR_H5_RSPL(unsigned int nr_rsp, const struct rsplo_scia *rspl)
{
     hid_t   gads_id;
     hsize_t adim;
     herr_t  stat;
...
void SCIA_LV1_WR_H5_RSPO(unsigned int nr_rsp, const struct rsplo_scia *rspo)
{
     hid_t   gads_id;
     hsize_t adim;
     herr_t  stat;
