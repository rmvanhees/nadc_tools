...
.INPUT/OUTPUT
  call as    SCIA_LV1_WR_H5_SRSN(nr_srsn, srsn);
     input:  
...
void SCIA_LV1_WR_H5_SRSN(unsigned int nr_srsn, const struct srsn_scia *srsn)
{
     hid_t   fid, ads_id;
     hsize_t adim;
     herr_t  stat;
 ...
 */
     adim = SCIENCE_PIXELS;
     srsn_type[0] = H5Topen(fid, "mjd", H5P_DEFAULT);
