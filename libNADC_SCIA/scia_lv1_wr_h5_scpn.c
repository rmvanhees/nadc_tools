...
.INPUT/OUTPUT
  call as    SCIA_LV1_WR_H5_SCPN(nr_scpn, scpn);
     input:  
...
void SCIA_LV1_WR_H5_SCPN(unsigned int nr_scpn, const struct scpn_scia *scpn)
{
     hid_t   ads_id;
     hsize_t adim;
     herr_t  stat;
 ...
 */
     adim = SCIENCE_PIXELS;
     scpn_type[0] = H5Topen(fid, "mjd", H5P_DEFAULT);
