...
{
     const char prognm[] = "SCIA_RD_H5_STRAY";
 ...
 */
     ...
     if ( stray->grid_in == NULL ) 
	  NADC_GOTO_ERROR( prognm, NADC_ERR_ALLOC, "stray->grid_in" );
...
int main()
{
     const char prognm[] = "test_rd_h5_stray";
     ...
     if ( IS_ERR_STAT_FATAL )
	  NADC_GOTO_ERROR( prognm, NADC_ERR_FATAL, "SCIA_RD_H5_STRAY" );
