--
-- Note: SCIA version (MSEC are micro-seconds)
...
BEGIN
	RETURN round((dsec - trunc(dsec)) * 1e6);
END;
$$ LANGUAGE plpgsql IMMUTABLE RETURNS NULL ON NULL INPUT;
