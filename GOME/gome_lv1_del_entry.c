...
.IDENTifer   GOME_LV1_DEL_ENTRY
.AUTHOR      R.M. van Hees
.KEYWORDS    GOME SQL
.LANGUAGE    ANSI C
.PURPOSE     remove entries in database for a GOME level 1 product
.INPUT/OUTPUT
  call as   GOME_LV1_DEL_ENTRY( conn, flname, softVersion )
     input:  
             PGconn *conn        :  PostgreSQL connection handle
	     char *flname        :  filename of the GOME Level 1 product
	     char *softVersion   :  S/W version of the GOME Level 1 product

.RETURNS     Nothing, error status passed by global variable ``nadc_stat''
.COMMENTS    Removes entries related to file "flname" from tables:
             meta__1P and tileinfo_meta__1P
.ENVIRONment None
.VERSION     2.1     22-Apr-2008   use cascade statements, RvH
             2.0     07-Mar-2007   port to PostgreSQL by R. M. van Hees
...
void GOME_LV1_DEL_ENTRY( PGconn *conn, const char *flname, 
