...
.IDENTifer   SCIA_WR_SQL_CH4_TILE
.AUTHOR      R.M. van Hees
.KEYWORDS    SCIA IMAP CH4 SQL
.LANGUAGE    ANSI C
.PURPOSE     write tile information of a Sciamachy IMAP product to database
.INPUT/OUTPUT
  call as   SCIA_WR_SQL_CH4_TILE( conn, sciafl, num_rec, rec );
     input:  
...
.COMMENTS    None
.ENVIRONment None
.VERSION     1.0     08-Dec-2008   initial release by R. M. van Hees
------------------------------------------------------------*/
/*
...
#define META_TBL_NAME "meta_imap_ch4"
#define TILE_TBL_NAME "tile_imap_ch4"

#define SQL_INSERT_TILE \
"INSERT INTO %s (pk_tile,fk_meta,julianDay,integrationTime,meanElevation,\
 VCD_CH4,VCD_CH4_ERROR,VCD_CO2,VCD_CO2_ERROR,xVMR_CH4,tile) \
...
{
     const char prognm[] = "SCIA_WR_SQL_CH4_TILE";
